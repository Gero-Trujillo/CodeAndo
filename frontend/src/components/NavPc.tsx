        ...
        <div className="w-full h-full flex flex-col justify-between p-6">
          <div className="flex flex-col gap-20 text-[#16bcc4]">
            ...
            <div className="flex flex-col gap-4 text-4xl">
              ...
              <span className="flex gap-2 cursor-pointer">
                <img className="w-10 h-10 rounded-full bg-[#1c626e]" src="https://robohash.org/1" alt="avatar" />
                <h2 className="text-3xl text-[#edfefd]">Profile</h2>
              </span>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <span className="text-5xl text-[#16bcc4] cursor-pointer">
                <CiLogout />
            </span>
            <span className="text-[#edfefd] text-3xl">
                Logout
            </span>
          </div>
        </div>
